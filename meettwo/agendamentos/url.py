...
from .views import home_page, servicos, agendar, dia_disponivel, exibir_horarios, API_exibir_horarios, desmarcar
...
urlpatterns = [
    ...
    path('desmarcar_agendamento/', desmarcar, name='desmarcar_H')
]